...
|-- internal/
|   |-- handlers/
|   |   |-- auth_handler.go    // Gestion de l'authentification
|   |   |-- post_handler.go    // Gestion des publications et des commentaires
|   |   |-- user_handler.go    // Gestion des utilisateurs et des profils
|   |
|   |-- models/
|   |   |-- user.go            // Structure de données pour les utilisateurs
|   |   |-- post.go            // Structure de données pour les publications et commentaires
|   |
|   |-- repositories/
|   |   |-- user_repo.go       // Accès à la base de données pour les utilisateurs
|   |   |-- post_repo.go       // Accès à la base de données pour les publications
|   |
|   |-- services/
|   |   |-- auth_service.go    // Logique métier pour l'authentification
|   |   |-- post_service.go    // Logique métier pour les publications
|   |   |-- user_service.go    // Logique métier pour les utilisateurs
|
|-- templates/                 // Fichiers HTML pour les vues
|
